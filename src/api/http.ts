...
import type { RequestGlobalConfigType, RequestConfigType } from "@/stores/modules/chartEditStore/chartEditStore.d";
 ...
 * @param {T} data 请求参数
 * @param {string} headersType 请求头格式  默认为json
 */
export const post = <T>(url: string, data?: T, headersType?: string) => {
  return axiosInstance({
    url: url,
