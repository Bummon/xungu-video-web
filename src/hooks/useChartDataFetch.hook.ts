  ...
  const requestIntervalFn = () => {
    ...
    try {
      ...
      if (requestUrl?.value) {
        ...
        // 定时时间
        const time = targetInterval.value && targetInterval.value ? targetInterval.value : globalRequestInterval.value;
        // 单位
        const unit = targetInterval.value && targetInterval.value ? targetUnit.value : globalUnit.value;
        // 开启轮询
