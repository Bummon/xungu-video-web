...
import { SCALE_KEY } from "@/views/mainData/diyLayout/preview/hooks/useScale.hook";
...
const rangeStyle = computed(() => {
  ...
  const selectColor = chartEditStore.getEditCanvasConfig.selectColor; //选中的颜色
  const backgroundColor = background ? background : undefined;
  // 如果有选中色就用颜色做背景  否则使用图片
