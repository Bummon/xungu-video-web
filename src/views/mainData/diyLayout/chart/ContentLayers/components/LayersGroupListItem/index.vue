...
import { useContextMenu, divider } from "@/views/mainData/diyLayout/chart/hooks/useContextMenu.hook";
...
@include go(content-layers-group-list-item) {
  ...
  .root-item-content {
    ...
    &.list-mini {
      ...
      .item-content {
        height: calc(#{$center-mini-height} - 10px) !important;
      }
      .select-modal {
        height: calc(#{$center-mini-height} + 2px) !important;
      }
    }
  }
  .select-modal,
  ...
  .item-content {
    ...
    width: calc(100% - 10px);
    height: calc(#{$center-height} - 10px);
    padding: 6px 5px;
  }
  .select-modal {
    width: 100%;
    height: calc(#{$center-height} + 2px);
