<template>
  ...
  >
    ...
    <!-- 图层内容 -->
    <div class="" v-if="reverseList.length === 0">
      <p class="not-layer-text">暂无图层~</p>
    </div>
...
import { ChartLayoutStoreEnum, LayerModeEnum } from "@/stores/modules/chartLayoutStore/chartLayoutStore.d";
import { useChartEditStore } from "@/stores/modules/chartEditStore/chartEditStore";
import { CreateComponentType, CreateComponentGroupType } from "@/packages/index.d";
import { MenuOptionsItemType } from "@/views/mainData/diyLayout/chart/hooks/useContextMenu.hook.d";
import { useContextMenu } from "@/views/mainData/diyLayout/chart/hooks/useContextMenu.hook";
...
const { GridIcon, ListIcon } = icon.ionicons5;
