...
import { SelectCreateDataType, SelectCreateDataEnum } from "./index.d.ts";
...
const isNotData = computed(() => {
  return (
    targetData.value.chartConfig?.chartFrame === ChartFrameEnum.STATIC || typeof targetData.value?.option?.dataset === "undefined"
  );
});
</script>
