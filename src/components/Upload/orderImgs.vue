...
<script setup lang="ts" name="OrderUploadImgs">
import { ref, computed, inject, watch } from "vue";
import { Plus } from "@element-plus/icons-vue";
import { fileRemove, fileRemoveByUrl, uploadImg } from "@/api/modules/upload";
...
const uploadSuccess = (response: { fileUrl: string } | undefined, uploadFile: UploadFile) => {
  ...
  uploadFile.ext = response.fileType;
...
const handleRemove = (file: UploadFile) => {
  ...
  const res = fileRemoveByUrl({ url: file.url });
  emit("update:fileList", _fileList.value);
};
