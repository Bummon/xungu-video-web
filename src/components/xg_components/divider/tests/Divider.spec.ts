...
describe("n-divider", () => {
  ...
  it("should work with `title-placement` prop", async () => {
    ...
    expect(wrapper.find(".n-divider").classes()).toContain("n-divider--title-position-left");

    await wrapper.setProps({ titlePlacement: "right" });
    expect(wrapper.find(".n-divider").classes()).toContain("n-divider--title-position-right");
    wrapper.unmount();
  });
  ...
  it("should work with `dashed` prop", async () => {
    ...
    expect(wrapper.find(".n-divider").classes()).toContain("n-divider--no-title");
    wrapper.unmount();
  });
  ...
  it("should work with `vertical` prop", async () => {
    ...
    expect(wrapper.find(".n-divider").classes()).toContain("n-divider--vertical");
    wrapper.unmount();
  });
});
